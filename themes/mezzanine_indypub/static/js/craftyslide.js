        ...
        return this.each(function () {
            ...
            function captions() {
                $slides.each(function () {
                    ...
                    $altCaption = $(this).find("img").attr("alt");
                    if ($altCaption !== undefined) {
                        $(this).prepend("<div class='altCaption'>" + $altCaption + "</div>");
                    }

                    $titleCaption = $(this).find("img").attr("title");
                    if ($titleCaption !== undefined) {
                        $(this).prepend("<div class='titleCaption'>" + $titleCaption + "</div>");
                    }
                    
                    $slides.filter(":first").find(".titleCaption").css("bottom", 0);
                    $slides.filter(":first").find(".altCaption").css("bottom", 0);
                });
            }
